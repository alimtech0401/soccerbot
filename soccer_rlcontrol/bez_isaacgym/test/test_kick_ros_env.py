...
from soccer_rlcontrol.resources.library.geometry.src.soccer_geometry.transformation import Transformation
from soccer_rlcontrol.resources.library.pycontrol.src.soccer_pycontrol import soccerbot_controller
from soccer_rlcontrol.resources.library.trajectories.src.soccer_trajectories import SoccerTrajectoryClass
from soccer_rlcontrol.bez_isaacgym.play import LaunchModel
from soccer_rlcontrol.bez_isaacgym.tasks.kick_ros_env import KickRosEnv
# python
import torch
import os
import yaml
...
class TestBezEnv(unittest.TestCase):
    """Test the bez_isaacgym environment."""
    ...
    def setUp(self) -> None:
        ...
        # create environment
        self.env = KickRosEnv(cfg=cfg, sim_device=args.sim_device,
